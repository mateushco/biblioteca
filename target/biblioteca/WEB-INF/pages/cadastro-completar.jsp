...
<body class="text-center">
	...
	<main class="form-signin w-100 m-auto">	
		...
		<div class="alert alert-warning alert-dismissible fade show" role="alert">
			<strong>Atenção!</strong> Você precisa completar o seu cadastro.
		</div>

		<form id="signUp" action="/biblioteca/cliente/completar-cadastro" method="post">
			
			<input type="hidden" id="id" name="id" value="${usuarioLogado.id}">

			<h1 class="h5 mb-3 fw-normal">Cadastro de Cliente</h1>
			<hr>

			<div class="form-floating">
				<input type="text" class="form-control" id="nome" name="nome" placeholder="Nome" value="${usuarioLogado.nome}" autofocus="autofocus"> 
