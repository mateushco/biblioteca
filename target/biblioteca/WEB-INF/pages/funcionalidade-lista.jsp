						...
						<div class="col-12">
							...
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Funcionalidades Cadastradas</h4>
								</div>
								<!-- /.card-header -->
								<div class="card-body">
									<table id="example" class="table table-striped"
										...
										<tbody>
											<c:forEach var="funcionalidade" items="${listFuncionalidade}">
												<tr>

													<td>${funcionalidade.nome}</td>
													<td>${funcionalidade.menu.nome}</td>
													<td>${funcionalidade.url}</td>
													<td>${funcionalidade.ordemMenu}</td>
													<td><a href="editar?id=${funcionalidade.id}">Editar</a> | <a
														href="deletar?id=${funcionalidade.id}">Deletar</a></td>
